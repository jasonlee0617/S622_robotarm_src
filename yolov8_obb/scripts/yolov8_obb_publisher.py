...
class Camera_subscriber(Node):
    ...
    def __init__(self):
        ...
        pkg_share = get_package_share_directory('yolov8_obb')
        default_weights = os.path.join(pkg_share, 'scripts', 'best.pt')
        self.model = YOLO(default_weights)
        self.model = YOLO('/home/robot/S622_robotarm/src/yolov8_obb/scripts/best.pt')

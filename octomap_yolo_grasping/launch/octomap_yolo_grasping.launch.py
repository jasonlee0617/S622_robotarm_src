...
def generate_launch_description():
    ...
    this_package_path = get_package_share_directory('octomap_yolo_grasping')
    ...
    rviz_config_file = os.path.join(
        get_package_share_directory("octomap_yolo_grasping"),
        "rviz",
        "octomap_yolo_grasping.rviz",
    )
    ...
    yolo_detector_node = TimerAction(
        ...
        actions=[
            Node(
                ...
                parameters=[{
                    # 'model_path': '/home/robot/S622_robotarm/yolo_obb.pt',
                    # 'model_path': '/home/robot/S622_robotarm/yolo-obb1.pt',
                    'model_path': '/home/robot/S622_robotarm/yolo-obb3.pt',
                    # 'model_path': '/home/robot/S622_robotarm/best.pt',
                    'device': 'auto',
                    'conf': 0.55,
                    'imgsz': 640,
    ...
    # ===== semantic_octomap_cloud_filter_node节点（延迟启动）=====
    psemantic_octomap_cloud_filter_node = TimerAction(
    ...
    pen_box_grasping_node = TimerAction(
        ...
        actions=[
            Node(
                package='octomap_yolo_grasping',
                executable='octomap_yolo_grasping',  
                name='octomap_yolo_grasping',
                output='screen'
            )
        ]
    )
    ...
    return LaunchDescription([
        ...
        # psemantic_octomap_cloud_filter_node,

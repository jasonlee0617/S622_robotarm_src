...
DEFAULTS = {
    ...
    "rviz_config": os.path.join(
        get_package_share_directory("yolov8_grasping"), "rviz", "visual_octmap.rviz"
    ),
...
def _launch_setup(context):
    package_share = get_package_share_directory("yolov8_grasping")
    ...
    grasp = TimerAction(period=8.0, actions=[Node(
        package="yolov8_grasping", executable="visual_grasping", name="visual_grasping",
    ...
    octomap_nodes = TimerAction(period=5.0, actions=[
        Node(
            package="yolo_perception", executable="semantic_octomap_cloud_filter.py",
        ...
        Node(
            package="yolov8_grasping", executable="dynamic_collision_objects",

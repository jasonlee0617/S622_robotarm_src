...
from visual_perception_utils.depth_estimation import robust_center3d_from_obb_depth
...
class LlmYoloPerceptionNode(Node):
    ...
    def __init__(self):
        ...
        self.create_service(
            SetBool,
            '/llm_visual_perception/set_inference_enabled',
            self._set_inference_enabled,
            callback_group=self._control_callback_group,
        )
        self.create_service(
            Trigger,
            '/llm_visual_perception/release_gpu',
            self._release_gpu,
            callback_group=self._control_callback_group,
        )

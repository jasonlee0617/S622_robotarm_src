#pragma once
#include <functional>
#include "myrobot_mpc_avoidance/mpc_solve_context.hpp"
...
//  所有默认值由 MPCParamsLoader / mpc_avoidance_params.yaml 统一定义
//  结构体内不做 "魔术数字" 硬编码
// ===================================================================
struct MPCParams {
    // ---- 1. 时间与预测时域 ----
    ...
    struct Deadlock {
        ...
        double clearance_improvement_min{};
        double local_recovery_sec{};
        double static_block_confirm_sec{};
        double replan_cooldown_sec{};
        double reference_lookahead_sec{};
        double reference_escape_prefix_sec{};
        double dynamic_clear_confirm_sec{};
        int    replan_max_per_goal{};
        double goal_identity_tolerance_rad{};
    } deadlock;

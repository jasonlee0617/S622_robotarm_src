"""Fairino 路径规划与 IK 对比的 Gazebo 演示入口。"""
...
def generate_launch_description():
    ...
    motion_planning_node = Node(
        ...
        executable="motion_planning_node_sim.py",
        name="motion_planning_node_sim",
        output="screen",
        emulate_tty=True,
        parameters=[
            ...
            {name: _LAUNCH_CONFIGURATIONS[name] for name in _NODE_DEFAULTS},
            {
                ...
                "spawn_sim_scene_models": _LAUNCH_CONFIGURATIONS[
                    "spawn_sim_scene_models"
                ],
                ...
                "sim_world": _LAUNCH_CONFIGURATIONS["world"],
            },
        ],
    )
    delayed_node = TimerAction(
        period=5.0,
        actions=[
            LogInfo(msg="[motion_planning_demo] 启动 Fairino 路径规划与 IK 对比。"),

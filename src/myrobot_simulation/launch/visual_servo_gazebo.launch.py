        ...
        actions=[
            Node(
                ...
                parameters=[{
                    ...
                    # "backend": "torch",
                    # "backend": "tensorrt",
                    "model_path": os.path.join(get_package_share_directory("yolo_perception"), "models", "yolo-obb-640.engine"),
                    "engine_path": os.path.join(get_package_share_directory("yolo_perception"), "models", "yolo-obb-640.engine"),
                    "device": "cuda:0",
                    "imgsz": 640,
                    "conf": 0.5,

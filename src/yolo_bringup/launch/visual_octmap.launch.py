...
DEFAULTS = {
    ...
    "rviz_config": os.path.join(
        get_package_share_directory("yolo_bringup"), "rviz", "visual_octmap.rviz"
    ),
...
def _launch_setup(context):
    package_share = get_package_share_directory("yolo_bringup")
    ...
    octomap_nodes = TimerAction(period=5.0, actions=[
        ...
        Node(
            package="yolo_bringup", executable="dynamic_collision_objects",

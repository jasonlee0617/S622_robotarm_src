...
from visual_servo.perception.obb_geometry import (
    angle_diff,
...
class YoloDetectorNode(Node):
    def __init__(self):
        ...
        self.declare_parameter('inference_period', 0.005)    # YOLO 推理周期
        self.declare_parameter('pose_publish_rate', 200.0)   # 输出发布频率
